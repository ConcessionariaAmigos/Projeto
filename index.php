    ...
    <section>
        <div class="banners">
            ...
            <div class="cardContent">
                ...
                <div class="card">
                    <img src="./imagens/empresaB.webp" alt="Novidades">
                    <h5>Somos uma empresa B!</h5>
                    <p>Somos uma das primeiras empresa do segmento a conquistar a certificação de empresa B.</p>
                    <a href="">Confira nosssas novidades &rarr;</a></div>
                <div class="card">
                    <img src="./imagens/lojas.png" alt="Nossas Lojas">
                    <h5>Nossas Lojas</h5>
        ...
        <div class="promotions">
            ...
            <div class="promotionsList">
                ...
                <img src="./imagens/promocoes2.jpg" alt="promoção 2">
            </div>
        </div>
    </section>
    <footer class="footer">
